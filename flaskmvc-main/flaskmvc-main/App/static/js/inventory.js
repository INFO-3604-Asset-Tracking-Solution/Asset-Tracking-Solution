...
async function submitAssignment() {
    const payload = {
        ...
        return_date: document.getElementById('assignReturnDate').value
    };
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <button class="dropdown-item"
                                        onclick="updateAssignmentStatus('${a.assignment_id}', 'Active')">
                                        Active
                                    </button>
                                ...
                                <li>
                                    <button class="dropdown-item"
                                        onclick="updateAssignmentStatus('${a.assignment_id}', 'Completed')">
                                        Completed
                                    </button>
                                </li>
                            </ul>
...
function handleSearch() {
    ...
    document.querySelectorAll('#assetTableBody tr').forEach(row => {
        ...
        if (filterState.statusFilters.size > 0) {
            ...
            matchesStatus = filterState.statusFilters.has(statusCell);
        }
