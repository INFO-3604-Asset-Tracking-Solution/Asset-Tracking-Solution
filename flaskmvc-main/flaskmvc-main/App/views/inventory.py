...
from App.controllers.assetassignment import create_asset_assignment, end_assignment, get_all_asset_assignment_json
...
def update_assignment_route(assignment_id):
    ...
    try:
        from App.controllers.assetassignment import update_asset_assignment
        updated = update_asset_assignment(
        ...
        return jsonify({'success': True, 'assignment': updated.get_json()})
